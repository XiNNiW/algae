...
// http://musicdsp.org/files/Audio-EQ-Cookbook.txt
    ...
    template<typename sample_t, typename frequency_t>
    const vcf<frequency_t> update_vcf(const vcf<frequency_t>& state, const sample_t& x, const sample_t& cutoff, const sample_t& q, const frequency_t sampleRate=44100.0){
