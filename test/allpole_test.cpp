...
using algae::dsp::filter::AllpoleNthOrder;

TEST(Filter_Test, CORE_allpole_construction) {
  constexpr size_t ORDER = 4;
  AllpoleNthOrder<double, ORDER> filter;
  std::array<double, ORDER> as = {2, 2, 4, 6};

  filter.setCoefficients(as.data());
...
TEST(Filter_Test, CORE_allpole_amplitude_response) {
  ...
  std::array<double, NUM_BINS> amp_response =
      compute_amplitude_response<double, AllpoleNthOrder<double, ORDER>,
  ...
  std::array<double, NUM_BINS> expected_response = {
      7.270189315729787,  6.963455974963548,   6.183334152635428,
      5.215720748410942,  4.285832238161064,   3.495025055353928,
      2.860396931702335,  2.3631829203539647,  1.9759666439869694,
      1.6734352060662772, 1.4352303202375125,  1.2458519814992424,
      1.093748381541115,  0.9703577285859104,  0.8693187492192285,
      0.7858741654524272, 0.7164358505455579,  0.6582721982766534,
      0.6092840105488725, 0.5678433798486314,  0.5326771687228805,
      0.5027821066106707, 0.4773624188821276,  0.4557836333628147,
      0.4375381050419817, 0.42221911308416693, 0.40950129711752237,
      0.3991258381042802, 0.3908892392639162,  0.38463488343617663,
      0.3802467752263896, 0.37764504702024143};
