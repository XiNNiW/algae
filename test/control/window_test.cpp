...
TEST(Control_Test, CoreWindowTest_BlackmanHarris) { 
    ...
    ASSERT_FLOAT_EQ(0.000059999998, blackman_harris<double>(double(idx++)/double(N)));
    ASSERT_FLOAT_EQ(0.010982331,    blackman_harris<double>(double(idx++)/double(N)));
    ASSERT_FLOAT_EQ(0.10301149,     blackman_harris<double>(double(idx++)/double(N)));
    ASSERT_FLOAT_EQ(0.38589266,     blackman_harris<double>(double(idx++)/double(N)));
    ASSERT_FLOAT_EQ(0.79383349,     blackman_harris<double>(double(idx++)/double(N)));
...
using algae::dsp::core::block_add;
...
TEST(Control_Test, CoreWindowTest_window_variable_block) { 
    ...
    block_add<double>(block,1,N,block);
...
TEST(Control_Test, CoreWindowTest_hann) { 
    ...
    ASSERT_FLOAT_EQ(0.095491506,    hann<double>(double(idx++)/double(N)));
    ASSERT_FLOAT_EQ(0.3454915,      hann<double>(double(idx++)/double(N)));
    ASSERT_FLOAT_EQ(0.65450847,     hann<double>(double(idx++)/double(N)));
    ASSERT_FLOAT_EQ(0.90450847,     hann<double>(double(idx++)/double(N)));
    ASSERT_FLOAT_EQ(1,              hann<double>(double(idx++)/double(N)));
    ASSERT_FLOAT_EQ(0.90450847,     hann<double>(double(idx++)/double(N)));
    ASSERT_FLOAT_EQ(0.65450847,     hann<double>(double(idx++)/double(N)));
    ASSERT_FLOAT_EQ(0.3454915,      hann<double>(double(idx++)/double(N)));
    ASSERT_FLOAT_EQ(0.095491506,    hann<double>(double(idx++)/double(N)));
